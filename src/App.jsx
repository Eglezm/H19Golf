                ...
                {tablaData.map(({ pl, pi, rowScores, total, vsPar, vsParHC }, pos) => (
                  <tr key={pl.id} style={{ borderBottom:`1px solid ${D.border}`, background:pos===0&&vsParHC!==null?D.goldDim+"55":"transparent" }}>
                    ...
                    {pars.map((par, hi) => {
                      ...
                      if (s===null||s===undefined) return <td key={hi} style={{ textAlign:"center", padding:"5px 3px", color:D.textDim, fontSize:11 }}>—</td>;
                      const d = s-par;
                      ...
                      return <td key={hi} style={{ textAlign:"center", padding:"4px 2px" }}><div style={{ width:22,height:22,borderRadius:r,border:`1.5px solid ${cbr}`,background:cb,color:cc,display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:700,margin:"0 auto" }}>{s}</div></td>;
                    })}
                  ...
                  {resTabla.map((p, pos) => (
                    <tr key={p.id} style={{ borderBottom:`1px solid ${D.border}`, background:pos===0?D.goldDim:D.card }}>
                      ...
                      {fullScores[p.pi].map((s,hi) => {
                        ...
                        return <td key={hi} style={{ textAlign:"center", padding:"4px 2px" }}><div style={{ width:20,height:20,borderRadius:r,border:`1.5px solid ${cbr}`,background:cb,color:cc,display:"flex",alignItems:"center",justifyContent:"center",fontSize:10,fontWeight:700,margin:"0 auto" }}>{s}</div></td>;
                      })}
